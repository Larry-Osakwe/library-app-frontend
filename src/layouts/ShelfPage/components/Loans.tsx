                ...
                <>
                    ...
                    {shelfCurrentLoans.map(shelfCurrentLoan => (
                        <div key={shelfCurrentLoan.book.id}>
                            ...
                            <hr/>
                            <LoansModal shelfCurrentLoan={shelfCurrentLoan} mobile={false} returnBook={undefined} renewLoan={undefined} />
                        </div>
                    ))}
                </> :
                <>
                ...
                <>
                    ...
                    {shelfCurrentLoans.map(shelfCurrentLoan => (
                        <div key={shelfCurrentLoan.book.id}>
                            ...
                            <hr/>
                            <LoansModal shelfCurrentLoan={shelfCurrentLoan} mobile={true} returnBook={undefined} 
                                renewLoan={undefined}/>
                        </div>
                    ))}
                </> :
